        ...
        <div className="w-full bg-[#ffffff]">
            <div className="w-full lg:w-[1168px] px-4 gap-8 flex flex-wrap lg:flex-nowrap justify-between mx-auto">
                ...
                <div className="py-4 md:py-10 lg:py-20 w-full lg:w-1/2 flex flex-col">
                    ...
                    <p className='mt-6'>Webteck is a passionate team of digital marketing experts dedicated to helping businesses of
                        all sizes achieve their online goals. We combine cutting-edge strategies with data-driven
                        insights to deliver measurable results.</p>

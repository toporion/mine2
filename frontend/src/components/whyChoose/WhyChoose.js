                ...
                <div className='w-full lg:w-[60%] p-4 rounded-lg text-left'>
                    ...
                    <div>
                        ...
                        <p className=' break-all'>
                            At Webteck, we are not just another digital marketing agency. We are a passionate team of
                            experts committed to empowering businesses of all sizes to thrive online. Our approach blends
                            innovative strategies with meticulous data analysis,
                        </p>

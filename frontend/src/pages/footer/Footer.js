  ...
  return (
    <div className="w-full bg-gray-900 text-white">
      <div className="relative">
        ...
        {/* Content Container */}
        <div className="absolute top-1/2 left-0 w-full transform -translate-y-1/2 px-6 md:px-8 flex flex-wrap md:flex-nowrap gap-8 justify-between text-center md:text-left">
